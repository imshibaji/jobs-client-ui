    ...
    return(
        <section className="relative overflow-hidden text-center py-24 md:py-32 px-6 bg-lavender leading-relaxed">
            <div className="relative z-10 max-w-3xl mx-auto">
                ...
                <h2 className="text-primary font-headline text-3xl md:text-4xl font-bold mb-4 leading-tight tracking-wider">Jobs That Fit Her Life. A Platform Built Just for Women.</h2>
                ...
                <a href={btn2?.link!} className="bg-transparent text-purple-700 border border-purple-700/10 rounded-full py-3 px-6 font-semibold cursor-pointer text-base hover:bg-purple-700/5">
